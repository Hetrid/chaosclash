...
import { LocalDriver, buildMatchConfig } from './net.js';
...
// ---------- match ----------
function startMatch(me, plannedAllies, enemyPicks, diff) {
  ...
  if (new URLSearchParams(location.search).get('dev') === '1') hud.buildDevPanel();
