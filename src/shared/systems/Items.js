...
export const ITEMS = {
  ...
  frostlens: { n: 'Frostlens Staff', cat: 'magic', cost: 2550, from: ['wand', 'wand', 'haste'], stats: { magPower: 58, cdr: 0.08 }, flags: { frostlens: 1 }, unique: 'Your skills chill targets: 15% slow for 1.2s.' },
